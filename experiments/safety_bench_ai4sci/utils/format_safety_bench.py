...
df = pd.read_csv('data/safetybench_ai4sci/ai4sci_safebench_20260123.csv', encoding='utf-8')
...
df.to_csv("data/safetybench_ai4sci/ai4sci_safebench_20260123_expanded.csv", encoding="utf-8")
